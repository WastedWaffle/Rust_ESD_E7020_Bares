...
//      
//    ** your answer here **
//      there is no instrucion or refrence about the panic handler.
//      Because in the optimized mode (--release) it skipps the unnecessarily to gain calculation speed.
//      i.e the panic handler is optimized out.
//      
//________________________________________________________________________________________
...
//    ** your answer here **
//
//    there is non instruction in between
//________________________________________________________________________________________
//
//    Where is the local variable stored?
...
//
//    ** your answer here **
//      there is not stored in any register.
//      this is possible because Rust + LLVM manage to not elide or reorder this volatile 
//      object due to there is few opration on the same object.    
//      i.e. it possible to be optimized out, cause we only have one variable in the memory and
//      it seems to not be in need of any memory management.
//________________________________________________________________________________________
